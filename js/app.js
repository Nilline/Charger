...
if (document.querySelector('.sports__row')) {
	let sliderSports = new Swiper('.sports__row', {
		...
		// Arrows
		// navigation: {
		// 	nextEl: '.slider__more_next',
		// 	prevEl: '.slider__more_prev',
		// },
...
// Слайдер Swiper включен выше 600px ширины экрана
(function () {
	...
	const enableSwiper = function () {
		if (document.querySelector('.content-wats__swiper')) {
			let sliderWatts = new Swiper('.content-wats__swiper', {
		...
		for (let i = 0; i < counter.length; i++) {
			...
			if (pos < win && counter[i].dataset.stop === "0") {
				...
				let int = setInterval(function () {
					...
					x = x + Math.ceil(counter[i].dataset.to / 500);
